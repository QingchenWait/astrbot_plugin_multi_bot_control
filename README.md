...
`require_explicit_target` 默认关闭。关闭时，只要消息来源命中机器人名单，就会进入限流逻辑；如果消息明确 @ 或引用回复了其他受控机器人，当前受控机器人会静默拦截，避免抢答。

开启 `require_explicit_target` 后，名单内机器人必须明确指向当前受控机器人，才允许当前受控机器人回复。明确目标包括：
